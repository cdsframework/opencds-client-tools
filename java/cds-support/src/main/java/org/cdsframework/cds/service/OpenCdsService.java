...
public class OpenCdsService {
    ...
    private final static QName qName = new QName(Configuration.getCdsNamespaceUri(), Configuration.getCdsLocalPart());
    private final static DecisionSupportService decisionSupportService = new DecisionSupportService(Configuration.getCdsWsdlUrl(), qName);
