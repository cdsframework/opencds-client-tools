package org.cdsframework.cds.base;
...
public abstract class BaseCdsObject<T> {
    ...
    private static CdsInput getCdsInput() {
        ...
        cdsInput.getTemplateIds().add(getII(Configuration.getCodeSystemOid("CDS_INPUT_ROOT")));
    ...
    private static CDSContext getCDSContext() {
        ...
        cdsContext.setCdsSystemUserPreferredLanguage(
                getCD(Configuration.getDefaultLanguageCode(),
                Configuration.getDefaultLanguageOid(),
                Configuration.getDefaultLanguageDisplayName()));
        return cdsContext;
    }

    private static Vmr getVmr() {
        Vmr vmr = new Vmr();
        vmr.getTemplateIds().add(getII(Configuration.getCodeSystemOid("VMR_ROOT")));
    ...
    private static EvaluatedPerson getEvaluatedPerson() {
        ...
        evaluatedPerson.getTemplateIds().add(getII(Configuration.getCodeSystemOid("EVALUATED_PERSON_ROOT")));
    ...
    private static ObservationResult getObservationResult() {
        ...
        observationResult.getTemplateIds().add(getII(Configuration.getCodeSystemOid("OBSERVATION_RESULT_ROOT")));
    ...
    private static CD getGeneralPurposeCode() {
        return getCD(Configuration.getGeneralPurposeCode(),
                Configuration.getCodeSystemOid("GENERAL_PURPOSE"));
    }
    ...
    public static SubstanceAdministrationEvent getSubstanceAdministrationEvent() {
        ...
        substanceAdministrationEvent.getTemplateIds().add(getII(Configuration.getCodeSystemOid("SUBSTANCE_ADMINISTRATION_EVENT_ROOT")));
    ...
    private static SubstanceAdministrationProposal getSubstanceAdministrationProposal() {
        ...
        substanceAdministrationProposal.getTemplateIds().add(getII(Configuration.getCodeSystemOid("SUBSTANCE_ADMINISTRATION_PROPOSAL_ROOT")));
    ...
    public static RelatedClinicalStatement getRelatedClinicalStatement(String targetRelationshipToSourceCode) {
        ...
        relatedClinicalStatement.setTargetRelationshipToSource(getCD(targetRelationshipToSourceCode, Configuration.getCodeSystemOid("TARGET_RELATIONSHIP_TO_SOURCE")));
    ...
    protected static <S> S addObservationResult(
        ...
        if (substanceAdministrationObject instanceof SubstanceAdministrationEvent) {
            ...
            focusValue = getConceptCode(Configuration.getCodeSystemOid("VACCINE_GROUP"), focus);

            observationValue = getObservationValue(Configuration.getCodeSystemOid("EVALUATION_VALUE"), value);

            for (String interpretation : interpretations) {
                if (interpretation != null && !interpretation.trim().isEmpty()) {
                    interpretationValues.add(getConceptCode(Configuration.getCodeSystemOid("EVALUATION_INTERPRETATION"), interpretation));
                }
            }
            ...
            observationValue = getObservationValue(Configuration.getCodeSystemOid("RECOMMENDATION_VALUE"), value);

            for (String interpretation : interpretations) {
                interpretationValues.add(getConceptCode(Configuration.getCodeSystemOid("RECOMMENDATION_INTERPRETATION"), interpretation));
            }
    ...
    protected static void setPatientGender(Vmr vmr, String gender) throws CdsException {
        CD cd = getConceptCode(Configuration.getCodeSystemOid("GENDER"), gender);
    ...
    protected static SubstanceAdministrationEvent getSubstanceAdministrationEvent(
        ...
        substance.setSubstanceCode(getConceptCode(Configuration.getCodeSystemOid("VACCINE"), substanceCode));
    ...
    protected static SubstanceAdministrationEvent addSubstanceAdministrationEvent(
        ...
        if (immId != null && !immId.trim().isEmpty()) {
            substanceAdministrationEvent.getId().setRoot(Configuration.getCodeSystemOid("CIR_IMMUNIZATION_ID"));
    ...
    protected static ObservationResult addImmunityObservationResult(Vmr vmr, Date observationEventTime, String focus, String value, String interpretation)
            throws CdsException {
        CD focusValue = getConceptCode(Configuration.getCodeSystemOid("DISEASE"), focus);
        ObservationValue observationValue = getObservationValue(Configuration.getCodeSystemOid("IMMUNITY_VALUE"), value);
        List<CD> interpretationValues = new ArrayList<CD>();
        CD interpretationValue = getConceptCode(Configuration.getCodeSystemOid("IMMUNITY_INTERPRETATION"), interpretation);
    ...
    protected SubstanceAdministrationProposal addSubstanceAdministrationProposal(
        ...
        if (substanceCode != null && !substanceCode.trim().isEmpty()) {
            ...
            substance.setSubstanceCode(getConceptCode(Configuration.getCodeSystemOid("VACCINE_GROUP"), vaccineGroup));
        }
        ...
        if (cdsObjectVmr != null) {
            ...
            if (patient != null) {
                if (patientId != null && !patientId.trim().isEmpty()) {
                    patient.getId().setRoot(Configuration.getCodeSystemOid("CIR_PATIENT_ID"));
